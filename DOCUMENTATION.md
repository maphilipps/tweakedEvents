...
In your collection's blueprint, make sure you have fields like in our sample [fieldset](https://github.com/carkDigital/statamic-events-v3/blob/main/resources/fieldsets/event.yaml).
...
Please see the example [calendar](https://github.com/carkDigital/statamic-events/blob/master/calendar.html) for how to create a monthly calendar using the `{{ events:calendar }}` tag.
...
Full example [here](https://github.com/carkDigital/statamic-events/blob/master/calendar.html).
