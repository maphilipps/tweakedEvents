...
namespace CarkDigital\Events\Tags;
...
use CarkDigital\Events\EventFactory;
use CarkDigital\Events\Events as EventsActions;
...
class Events extends CollectionTag
{
    ...
    public function nowOrParam(): string
    {
        ...
        if ($this->params->get('iso_format')) {
            return $month->isoFormat($this->params->get('iso_format'));
        } else {
